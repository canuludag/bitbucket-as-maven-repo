# Use Git(Bitbucket) As Maven Repository
...
3. Create a `gradle.properties` file in the root of your project (or better in the global `.gradle` folder on your system) with the following parameters
  ...
  Check [this blogpost](http://jeroenmols.com/blog/2015/08/13/artifactory2/) password to securely provide your username and password.
...
## Original Repository
@molsjeroen
https://github.com/JeroenMols/GitAsMaven
